...
namespace Utils.Settings
{
    public class ToolkitSettings
    {
        ...
        public static readonly float Version = 2.49f;
        ...
        public static void ReadINI()
        {
            ...
            float.TryParse(ReadKey("ScreenDepth", "ModelViewer", "5000"), out ScreenDepth);
            ...
            bool.TryParse(ReadKey("EnableNavigation", "ModelViewer", "1"), out bNavigation);
            ...
            bool.TryParse(ReadKey("LoadCollisions", "LoadOptions", "False"), out LoadCollisions);
            bool.TryParse(ReadKey("LoadActors", "LoadOptions", "False"), out LoadActors);
            bool.TryParse(ReadKey("LoadTranslokator", "LoadOptions", "False"), out LoadTranslokator);
            bool.TryParse(ReadKey("LoadAIWorld", "LoadOptions", "False"), out LoadAIWorld);
            bool.TryParse(ReadKey("LoadOBJData", "LoadOptions", "False"), out LoadOBJData);
            bool.TryParse(ReadKey("LoadRoads", "LoadOptions", "False"), out LoadRoads);
            bool.TryParse(ReadKey("LoadATP", "LoadOptions", "False"), out LoadATP);
            bool.TryParse(ReadKey("LoadItemDescs", "LoadOptions", "False"), out LoadItemDescs);
            bool.TryParse(ReadKey("LoadHPD", "LoadOptions", "False"), out LoadHPD);
            bool.TryParse(ReadKey("LoadSoundSectors", "LoadOptions", "False"), out LoadSoundSectors);
